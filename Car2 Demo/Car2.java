...
public class Car2
{
    ...
    { 
        ...
        carImage.setX(carImage.getX() +  (int)distX * (int)Math.sin( rotationInDegrees));
        carImage.setY(carImage.getY() +  (int)distY * (int)Math.cos(rotationInDegrees));
        
        rotationInRadians = Math.toRadians(carImage.getRotation());
